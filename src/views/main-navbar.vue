  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">{{storeName}}</a>
       <!-- <a class="site-navbar__brand-mini" href="javascript:;">时氪</a> -->
      </h1>
    </div>
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown">
			 <!-- <el-dropdown-item @click.native="set()">修改个人信息</el-dropdown-item>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      userName: {
        get () { 
					// return  JSON.parse(this.$cookie.get('userInfo')).managerName
			...
			init(){
				 this.$http.get(this.url+'/iotwebapi/api/publicrental/store/storeInfo').then((res)=>{
					...
					if(res.resultCode==0){
						...
						localStorage.setItem("title",this.storeName);
					}
					}) 
			},
	  // 修改个人信息
